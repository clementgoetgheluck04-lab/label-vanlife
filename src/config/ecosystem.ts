...
export const ECOSYSTEM_PRODUCTS: readonly EcosystemProduct[] = [
  ...
  { name: "Carte membre", role: "La carte membre numérique", description: "L’adhésion 2026 qui t’identifie comme membre Label Vanlife et ouvre l’accès aux avantages ainsi qu’à la MAP Label Vanlife.", icon: "compass", href: "/devenir-membre", status: "available" },
