...
export const ECOSYSTEM_PRODUCTS: readonly EcosystemProduct[] = [
  ...
  { name: "Carte membre", role: "La carte membre numérique", description: "L’adhésion 2027, active dès l’achat, qui t’identifie comme membre Label Vanlife et ouvre l’accès aux avantages ainsi qu’à la MAP Label Vanlife.", icon: "compass", href: "/devenir-membre", status: "available" },
  ...
  { name: "Vanlife Trips", role: "Les road trips", description: "Des itinéraires inspirants reliés à des étapes Vanlife Friendly et adaptés aux voyageurs itinérants.", icon: "route", href: "/blog#itineraires", status: "beta" },
