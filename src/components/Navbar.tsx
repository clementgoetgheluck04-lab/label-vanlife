          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            {authenticated === true ? (
              <div className="ml-2 flex items-center gap-1">
                <a href="/member" aria-label="Vous êtes connecté — ouvrir mon espace membre" className="inline-flex h-9 items-center justify-center gap-1.5 rounded-lg bg-sage px-3 text-xs font-semibold text-white shadow-sm transition-all hover:bg-sage-dark focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sage focus-visible:ring-offset-2"><CheckCircle2 className="h-4 w-4" /> Vous êtes connecté</a>
