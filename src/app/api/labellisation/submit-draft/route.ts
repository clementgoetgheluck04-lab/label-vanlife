      ...
      resend.emails.send({
        ...
        html: labelVanlifeEmail({
          ...
          details: [
            ...
            { label: "Offre limitée 2026", value: "110 € au lieu de 290 €" },
          ],
