...
export async function POST(request: NextRequest) {
  try {
    ...
    if (labelledPlace) {
      ...
      const renewalParagraph = `Merci de poursuivre l’aventure avec Label Vanlife. Le renouvellement 2027 de ${placeName} est confirmé. Votre fiche affiche les millésimes 2026 et 2027 ; le millésime 2026 disparaîtra automatiquement le 1er janvier 2027.`;
      const yearStatusParagraph = `Le renouvellement 2027 de ${placeName} est confirmé. Votre fiche affiche désormais les millésimes 2026 et 2027 ; le millésime 2026 disparaîtra automatiquement le 1er janvier 2027.`;
      const kitParagraph = "Votre kit réunit les six visuels officiels 2027, prêts à être utilisés sur votre site internet, vos réseaux sociaux, vos newsletters, vos brochures et vos supports d’accueil. Vous pouvez aussi placer le logo dans le pied de page de votre site et rendre l’image cliquable vers https://www.labelvanlife.fr/.";
      const messageParagraphs = labelledPlace.contact.kitEmailParagraphs?.length
        ? [yearStatusParagraph, ...labelledPlace.contact.kitEmailParagraphs, kitParagraph]
        : [renewalParagraph, kitParagraph];
      ...
      const { error } = await resend.emails.send({
        ...
        html: labelVanlifeEmail({
          preheader: labelledPlace.contact.kitEmailPreheader || `Le renouvellement 2027 de ${placeName} est confirmé : découvrez vos six visuels officiels.`,
          eyebrow: "LABEL VANLIFE · PARTENAIRE 2027",
          title: labelledPlace.contact.kitEmailTitle || "Votre kit de communication 2027 est prêt",
