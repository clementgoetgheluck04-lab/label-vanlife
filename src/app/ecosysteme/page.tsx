  ...
  return (
    <div className="min-h-screen bg-neutral-50 pt-28 pb-20">
      ...
      <section className="mx-auto mt-16 max-w-2xl px-6 text-center">
        ...
        <Link href="/devenir-membre"><Button variant="cta" size="lg" className="mt-6 gap-2">Découvrir la carte membre — 19 € au lieu de 39 € <ArrowRight className="h-4 w-4" /></Button></Link>
      </section>
    </div>
  );
}
