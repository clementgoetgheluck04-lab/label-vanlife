...
export const metadata: Metadata = {
  ...
  openGraph: { title, description, type: "article", url: "/dormir-en-van", images: [{ url: "/images/hero-label-vanlife.webp", width: 1536, height: 1024, alt: "Dormir en van en France" }] },
};
...
export default function DormirEnVanPage() {
  const schemas = [
    { "@context": "https://schema.org", "@type": "Article", headline: title, description, image: "https://www.labelvanlife.fr/images/hero-label-vanlife.webp", author: { "@type": "Organization", name: "Label Vanlife" }, publisher: { "@type": "Organization", name: "Label Vanlife" }, mainEntityOfPage: "https://www.labelvanlife.fr/dormir-en-van", datePublished: "2026-01-01", dateModified: "2026-08-02" },
  ...
  return (
    <main className="bg-white pb-24 pt-16 text-neutral-800">
      ...
      <article className="mx-auto max-w-5xl space-y-20 px-6">
        ...
        <section className="grid gap-5 sm:grid-cols-2"><Link href="/blog#itineraires" className="micro-card rounded-2xl border border-neutral-200 p-6"><p className="text-xs font-bold uppercase tracking-widest text-[#9a7445]">Itinéraires</p><h2 className="mt-2 text-xl font-bold text-neutral-950">Les meilleurs road trips en France</h2><span className="mt-4 inline-flex items-center gap-2 text-sm font-bold text-emerald-700">Découvrir <ArrowRight className="h-4 w-4" /></span></Link><Link href="/vanlife" className="micro-card rounded-2xl border border-neutral-200 p-6"><p className="text-xs font-bold uppercase tracking-widest text-[#9a7445]">Guide complet</p><h2 className="mt-2 text-xl font-bold text-neutral-950">La vanlife en France</h2><span className="mt-4 inline-flex items-center gap-2 text-sm font-bold text-emerald-700">Lire le guide <ArrowRight className="h-4 w-4" /></span></Link></section>
